...
2.4 Имя и фамилию генерировать из случайного набора букв английского алфавита (например с длиной от 5 до 10 символов.
...
Подсказки:
1. у каждого символа char есть соответствующее ему число
